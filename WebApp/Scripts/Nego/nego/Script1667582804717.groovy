...
WebUI.callTestCase(findTestCase('Login/L001 - Login dengan username dan password benar'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Kategori/div_Alat Tensi'))
